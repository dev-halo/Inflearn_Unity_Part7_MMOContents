...
namespace Server.Game
{
    public class GameRoom : JobSerializer
    {
        ...
        public void LeaveGame(int objectId)
        {
            ...
            if (type == GameObjectType.Player)
            {
                if (players.Remove(objectId, out Player player) == false)
                    return;
            ...
            {
                if (monsters.Remove(objectId, out Monster monster) == false)
                    return;
            ...
            {
                if (projectiles.Remove(objectId, out Projectile projectile) == false)
                    return;
        ...
        public void HandleSkill(Player player, C_Skill skillPacket)
        {
            ...
            if (DataManager.SkillDict.TryGetValue(skillPacket.Info.SkillId, out Skill skillData) == false)
                return;
